...
int main()
{
    ...
    outf << "Число выживших: " << survival << endl;
    ...
    outf << "Средний возраст женщин: " << aFemale << ". Мужчин: " << aMale << endl;
    outf << "Штат, в который приземлилось  больше всего пассажиров: " << mostState <<endl;
    outf << "Id несовершеннолетних: " << underAgeId[0];
